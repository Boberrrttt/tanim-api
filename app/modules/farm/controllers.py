...
from .services import create, get_all, get_by_farmer_id, update_location
from .schemas import CreateFarm, UpdateFarmLocation
...
async def update_farm_location_controller(
    payload: UpdateFarmLocation, db: Session = Depends(get_db)
):
    return await update_location(db, payload)